  ...
  return (
    <section className="roadmap" id="roadmap">
      ...
      <p className="heading-text">
        ...
        Onchain Proof), so you will get a cool nipple that with the power of the
        community and NFN(Non-Fungiblenomics)retains its value and you will also
        aid to a good cause.
      </p>
      <div className="roadmap-text">
        <div className="roadmap-list">
          <p>0% The journey begins, welcome to the Nippleverse</p>
          <ul>
            <li>
        ...
        <div className="roadmap-list">
          <p>25%-Expanding the Nippleverse</p>
          <ul>
        ...
        <div className="roadmap-list">
          <p>50%- 4th Wall break</p>
          <ul>
            <li> Meme contest, the winner will receive 1ETH and 1 nipple </li>
            <li>
              Retweet giveaway: A random person that retweets and follows gets a
              nipple
            </li>
            <li>SETH community airdrop to random holders </li>
            <li>
              Nipples worth 32500$ will be bought and burned to lift the floor
              price
            </li>
          </ul>
        </div>
        <div className="roadmap-list">
          <p>75%-Vincent van Nipple </p>
          <ul>
            <li>
              Nipple Art contest: Use nipples in the most creative ways and post
              them on twitter with the #nippleverse hashtag, the winner gets
              1ETH
            </li>
            <li>SETH community airdrop to random holders </li>
            <li>
              Nipples worth 50000$ will be bought and burned to lift the floor
              price
            </li>
          </ul>
        </div>
